...
using Afx.vsix.ProjectFlavour.ClassLibrary;
...
namespace Afx.vsix
{
  ...
  [ProvideProjectFactory(typeof(ClassLibraryProjectFactory), "Class Library", null, null, null, null)] // @".\ProjectFlavour\ServiceLibrary\Template")]
  [ProvideProjectFactory(typeof(ServiceLibraryProjectFactory), "Service Library", null, null, null, null)] // @".\ProjectFlavour\ServiceLibrary\Template")]
  public sealed class AfxPackage : Package
  {
    /// <summary>
    /// AfxPackage GUID string.
    /// </summary>
    public const string PackageGuidString = "4866e090-6a66-403d-97aa-4ca78cf4d610";

    /// <summary>
    /// Initializes a new instance of the <see cref="AfxPackage"/> class.
    /// </summary>
    public AfxPackage()
    {
    ...
    {
      AfxWizard.AfxWizard.Initialize(this);
