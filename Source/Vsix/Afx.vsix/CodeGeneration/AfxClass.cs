...
namespace Afx.vsix.CodeGeneration
{
    ...
    #line 1 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\AfxClass.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "14.0.0.0")]
    public partial class AfxClass : AfxClassBase
    {
#line hidden
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            #line 11 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\AfxClass.tt"
this.Template_AfxClass_Render(this.ns, this.name, this.baseClass, owner, hasDataContract, isPersistent, isAggregateRoot);
        ...
        #line 1 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxClass.ttinclude"
...
{			
        ...
        #line 4 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxClass.ttinclude"
...
this.Write(" \r\nusing System;\r\nusing System.Collections.Generic;\r\nusing System.Linq;");
        ...
        #line 7 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxClass.ttinclude"
...
this.Write("\r\nusing System.Text;\r\nusing System.Threading.Tasks;\r\n\r\nnamespace ");
        ...
        #line 11 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxClass.ttinclude"
...
this.Write("\r\n{");
        ...
        #line 12 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxClass.ttinclude"
...
this.Write("  \r\n  public class ");
        ...
        #line 13 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxClass.ttinclude"
...
this.Write(" : ");
        ...
        #line 13 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxClass.ttinclude"
this.Write(this.ToStringHelper.ToStringWithCulture(baseClass == null ? (owner == null ? "AfxObject" : string.Format("AfxObject<{0}>", owner)) : baseClass));
        ...
        #line 13 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxClass.ttinclude"
this.Write(this.ToStringHelper.ToStringWithCulture(isAggregateRoot ? ", IAggregateRoot" : string.Empty));
...
this.Write("\r\n  {\r\n");
        ...
        #line 15 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxClass.ttinclude"
 if (isAggregateRoot) {
        ...
        #line 15 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxClass.ttinclude"
this.Write("    #region IAggregateRoot\r\n\r\n    public int Revision { get; set; }\r\n    public D" +
        "ateTime? RevisionDate { get; set; }\r\n\r\n    #endregion\r\n");

        
        #line default
        #line hidden
        
        #line 21 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxClass.ttinclude"
}
...
this.Write("  }\r\n}\r\n");
        ...
        #line 23 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxClass.ttinclude"
}
...
private bool _isAggregateRootField;

/// <summary>
/// Access the isAggregateRoot parameter of the template.
/// </summary>
private bool isAggregateRoot
{
    get
    {
        return this._isAggregateRootField;
    }
}
...
bool isAggregateRootValueAcquired = false;
if (this.Session.ContainsKey("isAggregateRoot"))
{
    this._isAggregateRootField = ((bool)(this.Session["isAggregateRoot"]));
    isAggregateRootValueAcquired = true;
}
if ((isAggregateRootValueAcquired == false))
{
    string parameterValue = this.Host.ResolveParameterValue("Property", "PropertyDirectiveProcessor", "isAggregateRoot");
    if ((string.IsNullOrEmpty(parameterValue) == false))
    {
        global::System.ComponentModel.TypeConverter tc = global::System.ComponentModel.TypeDescriptor.GetConverter(typeof(bool));
        if (((tc != null) 
                    && tc.CanConvertFrom(typeof(string))))
        {
            this._isAggregateRootField = ((bool)(tc.ConvertFrom(parameterValue)));
            isAggregateRootValueAcquired = true;
        }
        else
        {
            this.Error("The type \'System.Boolean\' of the parameter \'isAggregateRoot\' did not match the ty" +
                    "pe of the data passed to the template.");
        }
    }
}
if ((isAggregateRootValueAcquired == false))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("isAggregateRoot");
    if ((data != null))
    {
        this._isAggregateRootField = ((bool)(data));
    }
}
