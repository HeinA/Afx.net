...
namespace Afx.vsix.CodeGeneration
{
    ...
    #line 1 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\AfxServiceImplementation.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "14.0.0.0")]
    public partial class AfxServiceImplementation : AfxServiceImplementationBase
    {
#line hidden
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            #line 8 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\AfxServiceImplementation.tt"
this.Template_AfxServiceInterface_Render(this.ns, this.name, serviceType, interfaceName);
        ...
        #line 1 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxServiceImplementation.ttinclude"
...
{			
        ...
        #line 4 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxServiceImplementation.ttinclude"
...
namespace ");
        ...
        #line 14 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxServiceImplementation.ttinclude"
...
this.Write("\r\n{\r\n  [ServiceBehavior(ConcurrencyMode = ConcurrencyMode.Multiple)]\r\n  public cl" +
        ...
        #line 17 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxServiceImplementation.ttinclude"
...
this.Write(" ");
        ...
        #line 17 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxServiceImplementation.ttinclude"
this.Write(this.ToStringHelper.ToStringWithCulture(string.IsNullOrWhiteSpace(serviceType) ? string.Empty : string.Format(": {0} , ", serviceType)));
...
this.Write("\r\n  {\r\n  }\r\n}\r\n");
        ...
        #line 21 "C:\Dev\Afx.net v2\Source\Vsix\Afx.vsix\CodeGeneration\.\Business\AfxServiceImplementation.ttinclude"
}
...
{
    string parameterValue = this.Host.ResolveParameterValue("Property", "PropertyDirectiveProcessor", "interfaceName");
    if ((string.IsNullOrEmpty(parameterValue) == false))
    {
        global::System.ComponentModel.TypeConverter tc = global::System.ComponentModel.TypeDescriptor.GetConverter(typeof(string));
        if (((tc != null) 
                    && tc.CanConvertFrom(typeof(string))))
        {
            this._interfaceNameField = ((string)(tc.ConvertFrom(parameterValue)));
            interfaceNameValueAcquired = true;
        }
        else
        {
            this.Error("The type \'System.String\' of the parameter \'interfaceName\' did not match the type " +
...
if ((interfaceNameValueAcquired == false))
{
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "14.0.0.0")]
    public class AfxServiceImplementationBase
    {
        #region Fields
